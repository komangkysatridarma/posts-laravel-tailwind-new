      ...
      <div class="mb-5">
          <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="flex items-center justify-between p-4">
              <button class="px-2 py-1 mb-1 md:px-4 md:py-2 lg:px-4 lg:py-2 text-sm md:text-base lg:text-lg bg-blue-500 text-white rounded hover:bg-blue-700"><a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none">Read More</a></button>
