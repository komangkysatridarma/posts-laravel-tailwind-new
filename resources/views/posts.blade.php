      ...
      <div class="mb-5">
          <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="flex items-center justify-between p-4">
              <button class="lg:px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 sm:text-xs "><a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none">Read More</a></button>
          ...
          <div class="w-full md:w-1/2 lg:w-1/3 px-2 mb-4">
            <div class="max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden post-card">
              ...
              <div class="flex items-center justify-between p-4 post-card-actions">
                <button class="lg:px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 sm:text-xs "><a href="/posts/{{ $post->slug }}" class="text-decoration-none">Read More</a></button>
